...
- [AGENTS.md](https://github.com/plugboard-dev/plugboard/blob/main/AGENTS.md) - General guidelines for working with the Plugboard codebase.
- [examples/AGENTS.md](https://github.com/plugboard-dev/plugboard/blob/main/examples/AGENTS.md) - Specific guidance for building example models and demos.
- Copilot-specific agents `docs`, `lint` and `test`.
